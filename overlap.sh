...
# done
# for n in `seq -w 100 100 2000`; do for i in `seq -w 0 19`; do  node js/src/draw_webcola.js --graphFile data/graph/overlap/$n/node_n\=${n}_$i.json --output data/drawing/webcola/overlap/$n/node_n\=${n}_$i.json; done; done
